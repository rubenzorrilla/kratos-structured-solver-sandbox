    ...
    std::array<int, 4>& rCellIds)
{
    ...
    rCellIds[1] = GetNodeGlobalId(I + 1, J, rBoxDivisions);
    rCellIds[2] = GetNodeGlobalId(I + 1, J + 1, rBoxDivisions);
    rCellIds[3] = GetNodeGlobalId(I, J + 1, rBoxDivisions);
}
    ...
    std::array<int, 8>& rCellIds)
{
    ...
    rCellIds[1] = GetNodeGlobalId(I + 1, J, K, rBoxDivisions);
    rCellIds[2] = GetNodeGlobalId(I + 1, J + 1, K, rBoxDivisions);
    rCellIds[3] = GetNodeGlobalId(I, J + 1, K, rBoxDivisions);
    rCellIds[4] = GetNodeGlobalId(I, J, K + 1, rBoxDivisions);
    rCellIds[5] = GetNodeGlobalId(I + 1, J, K + 1, rBoxDivisions);
    rCellIds[6] = GetNodeGlobalId(I + 1, J + 1, K + 1, rBoxDivisions);
    rCellIds[7] = GetNodeGlobalId(I, J + 1, K + 1, rBoxDivisions);
}
